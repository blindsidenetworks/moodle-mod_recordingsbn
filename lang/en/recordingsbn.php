...
$string['view_deprecated_msg_user'] = 'This Plugin has been deprecated. Contact techincal support.';
$string['view_deprecated_info_admin'] = 'Since version 2.2 it is possible to add a BigBlueButtonBN instance in Recordings only mode for getting RecordingsBN functionality.';
$string['view_deprecated_info_user'] = 'You may find in this same course an instance of BigBlueButtonBN that replacees this one.';
