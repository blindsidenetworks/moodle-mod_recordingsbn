...
$string['view_deprecated_msg'] = 'RecordingsBN has been phased out and it can only be used with BigBlueButtonBN 2.1.x';
$string['view_deprecated_info'] = 'Since version 2.2 it is possible to use BigBlueButtonBN instances for getting RecordingsBN functionality when configuring them as "Recordings only".';
...
$string['view_deprecated_migrate_admin'] = 'As Administrator you can have them migrated all at once through the plugin settings.';
$string['view_deprecated_migrate_teacher'] = 'The current instances of RecordingsBN can be migrated manually by creating in the same course and section a corresponding instance of BigBlueButtonBN in "Recordings Only" mode.';
$string['view_deprecated_migrate_user'] = 'Please contact your Teacher or Technical Support.';
$string['view_deprecated_migrate_admin_warning'] = 'But be adviced that the process can not be reverted.';
